...
const { invoices, customers, revenue, users } = require('../app/lib/placeholder-data.ts');
...
async function main() {
  console.log("🚀 ~ main ~ process.env.LOCAL_VERCEL_POSTGRES:", process.env.LOCAL_VERCEL_POSTGRES)
